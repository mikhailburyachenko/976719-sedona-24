...
* Студент: [Буряченко Михаил](https://up.htmlacademy.ru/htmlcss/24/user/976719).
* Наставник: `Даниил Сугоняев`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/976719-sedona-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
